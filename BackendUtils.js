  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sgboxer) Block Dash 1v1",
      descriptionKey: "Practice your skills in the Stumble Boxer TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sgboxer) Block Dash Legendary 1v1",
      descriptionKey: "Practice your skills in the Stumble Boxer TournamentX! mode!",
